<template>
  <div class="flex flex-wrap justify-between w-4/5 ml-20">
    <v-text-field readonly class="w-4 mr-8" v-model="selectZhishu"></v-text-field>
    <v-text-field readonly class="w-4 mr-4" v-model="shorttermAverage"></v-text-field>
    <v-text-field readonly class="w-4 mr-4" v-model="longtermAverage"></v-text-field>
    <v-text-field readonly class="w-4 mr-4" v-model="mainContract"></v-text-field>
